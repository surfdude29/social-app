        ...
        isNative
          ? _(
              msg({
                ...
                comment: `Accessibility hint for button in composer to add photos or a video to a post on native. Maximum number of images that can be selected is currently 4 but may increase in the future.`,
              }),
            )
          : _(
              msg({
                ...
                comment: `Accessibility hint for button in composer to add photos or a video or a GIF to a post on web. Maximum number of images that can be selected is currently 4 but may increase in the future.`,
              }),
            )
      }
      style={a.p_sm}
